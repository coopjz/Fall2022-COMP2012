...
void testcase2()
{
    ...
    Mail *m = new Mail(1, "Starbucks, Academic Concourse, HKUST, Clear Water Bay, Sai Kung, NT", District::SaiKung, "HKUST", "Please give students more discount");
    cerr << "adddress hash: " << m->getAddressHash() << endl;
    po->addMail(m);
...
void testcase17()
{
    ...
    Mail *m3 = new Mail(3, "Bookstore, Academic Concourse, HKUST, Clear Water Bay, Sai Kung, NT", District::SaiKung, "HKUST", "Please give students more discount");
    po->addMail(m3);
    Mail *m4 = new Mail(4, "HSBC, Sai Kung Town", District::SaiKung, "Sample", "Hello there!");
    po->addMail(m4);
    Mail *m5 = new Mail(5, "HSBC Building, Central", District::SaiKung, "Queens Road Central", "Hello there!");
    po->addMail(m5);

    Mail *m6 = new Mail(6, "New Sample Town", District::SaiKung, "Sample", "Hello there!");
    po->addMail(m6);

    Mail *m7 = new Mail(7, "HSBC, Sai Kung Town", District::SaiKung, "Sample", "Hello there!");
    po->addMail(m7);

    Mail *m8 = new Mail(8, "Sample Building, Sample 2 Street, Kennedy Town", District::SaiKung, "Sample", "Hello there!");
    po->addMail(m8);

    Mail *m9 = new Mail(9, "HSBC Building, Central", District::SaiKung, "Queens Road Central", "Hello there!");

    po->addMail(m9);
    Mail *m10 = new Mail(10, "euding, Central", District::SaiKung, "sueens Rod Cenral", "Hello thre!");

    po->addMail(m10);
    Mail *m11 = new Mail(11, "duilding, Cenral", District::SaiKung, "cueens Rod Cenral", "Hello thre!");

    po->addMail(m11);
    Mail *m12 = new Mail(12, "cuildkding, Central", District::SaiKung, "auns Rod Ceerjdnal", "Hello th553re!");

    po->addMail(m12);
    Mail *m13 = new Mail(13, "fuildiehdeng, Central", District::SaiKung, "puns R Ceerjdnal", "Hlo th553re!");

    po->addMail(m13);
    Mail *m14 = new Mail(14, "gdiggjng, Cedvgegel", District::SaiKung, "duns R Ceerjdnal", "Hlo th553re!");
...
void testcase18()
{
    ...
    Mail *m = new Mail(1, "Starbucks, Academic Concourse, HKUST, Clear Water Bay, Sai Kung, NT", District::SaiKung, "HKUST", "Please give students more discount");
    po->addMail(m);
    po->remove(District::SaiKung, 1, "HKUST");
