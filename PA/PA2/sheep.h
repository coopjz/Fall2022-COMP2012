...
public:
    Sheep(Board *board) : Animal(board, SHEEP_HUNGER_COOLDOWN / 2, SHEEP_BREED_COOLDOWN, SHEEP_MOVE_COOLDOWN) {}
    Sheep(const Sheep &sheep) : Animal(sheep.getBoard(), sheep.getHungerCounter(), sheep.getBreedCounter(), sheep.getMoveCounter()) {}
