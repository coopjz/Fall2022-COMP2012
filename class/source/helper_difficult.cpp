...
{
    monster_map->set_monster(2, 2, new Monster("Slime", 100, 10, 10, 10, 2, 2, 10, ICE));
    monster_map->set_monster(2, 4, new Monster("Centipedes", 100, 10, 10, 10, 4, 2, 10, ICE));
    monster_map->set_monster(3, 3, new Monster("Desmond", 100, 10, 10, 10, 3, 3, 10, ICE));
    monster_map->set_monster(5, 5, new Monster("Mak", 100, 100, 10, 10, 5, 5, 10, ICE));
    monster_map->set_monster(4, 2, new Monster("Grey", 100, 10, 10, 10, 2, 4, 10, ICE));
}
