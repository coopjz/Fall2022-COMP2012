...
class Student {
   public:
    ...
    Student(const Student &student) : name_(student.name()), score_(student.score()) {}
...
enum class HashCellState { Empty, Active, Deleted };
...
enum class ProbeMode { Linear, Quadratic, DoubleHash };
